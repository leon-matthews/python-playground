...
its `Wikipedia article <http://en.wikipedia.org/wiki/WDDX>`_ WDDX was a precursor
to SOAP (which may help explain some of the latter's brain-damage :-)
...
contain  control characters in strings, eg. <char code='0C'/>.  This feature
